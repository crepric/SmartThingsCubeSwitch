...
//         input "cube_sensor", "capability.sensor", required: true, title: "Which sensor is inside the cube?"
//          input "cube_sensor", "currentFace", required: true, title: "Which sensor is inside the cube?"
    }
    ...
    section("Scene 2") {
		input (name:"temp_2", type:"number", range: "2500..6500", required: true, title: "What is the light temperature?")
        input (name:"bright_2", type:"number", range: "0..100", required: true, title: "What is the brightness level?")
    }
    section("Scene 3") {
		input (name:"temp_3", type:"number", range: "2500..6500", required: true, title: "What is the light temperature?")
        input (name:"bright_3", type:"number", range: "0..100", required: true, title: "What is the brightness level?")
    }
    section("Scene 4") {
		input (name:"temp_4", type:"number", range: "2500..6500", required: true, title: "What is the light temperature?")
        input (name:"bright_4", type:"number", range: "0..100", required: true, title: "What is the brightness level?")
    }
    section("Scene 5") {
		input (name:"temp_5", type:"number", range: "2500..6500", required: true, title: "What is the light temperature?")
        input (name:"bright_5", type:"number", range: "0..100", required: true, title: "What is the brightness level?")
    }
    section("Scene 6") {
		input (name:"temp_6", type:"number", range: "2500..6500", required: true, title: "What is the light temperature?")
